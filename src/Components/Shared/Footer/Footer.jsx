        ...
        <footer>
            <nav className="footer-nav">
                ...
                >
                    ...
                    <span className={`nav-text ${selectedItem === 'Home' ? 'selected-text' : ''}`}>Home</span>
                </div>

                <div
                    className={`nav-item ${selectedItem === 'Saved' ? 'selected' : ''}`}
                ...
                >
                    ...
                    <span className={`nav-text ${selectedItem === 'Saved' ? 'selected-text' : ''}`}>Saved</span>
                </div>
                <Link>
                    <div
                        className={`nav-item ${selectedItem === 'Cart' ? 'selected' : ''}`}
                        onClick={() => {
                    ...
                    >
                        ...
                        <span className={`nav-text ${selectedItem === 'Cart' ? 'selected-text' : ''}`}>Cart</span>
                    </div>
                </Link>
                <div
                    className={`nav-item ${selectedItem === 'Settings' ? 'selected' : ''}`}
                ...
                >
                    ...
                    <span className={`nav-text ${selectedItem === 'Settings' ? 'selected-text' : ''}`}>Settings</span>
                </div>
            </nav>
        </footer>
